...
int main (){
    int numberOfoneProduct,numberOfTwoProduct,numberOfthreeProduct,numberOffourProduct,numberOffiveProduct,numberOfsixProduct;
    float oneProductValue,totalValueOneProduct,twoProductValue,totalValueTwoProduct,threeProductValue,totalValuethreeProduct,fourProductValue,totalValuefourProduct,fiveProductValue,totalValuefiveProduct,sixProductValue,totalValuesixProduct;
    float totalpurchase,totalDiscount;
    char oneProductName[20],twoProductName[20],threeProductName[20],fourProductName[20],fiveProductName[20],sixProductName[20];
    char newProduct,validTv;
    printf("**********BIENVENIDO**********\nEn este programa podras conocer el valor total de tus productos y mirar tu descuento para el mes de Septiembre\n");
    printf("FACTURA\n");
    dateAndTime();
    system("pause");
                ...
                if(newProduct == 's'){
                    ...
                    if(newProduct == 's'){
                        ...
                        if(newProduct == 's'){
                            ...
                            printf("<<<Limite de productos facturados 6>>>");
